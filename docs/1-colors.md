...
Luego, los he organizado en el archivo `colors.ts` para definir la **paleta de colores de mi aplicación**, usando nombres descriptivos para facilitar su uso.
